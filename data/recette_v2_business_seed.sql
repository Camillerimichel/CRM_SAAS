...
VALUES
(@client_id_1, 'RECETTE-V2-ALICE-01', NOW(), NOW(), 3, 3, 0.50, NULL, @co_lille_centre_id),
(@client_id_2, 'RECETTE-V2-BRUNO-01', NOW(), NOW(), 4, 4, 0.65, NULL, @co_lille_centre_id),
(@client_id_3, 'RECETTE-V2-CLAIRE-01', NOW(), NOW(), 2, 2, 0.45, NULL, @co_lille_est_id),
(@client_id_4, 'RECETTE-V2-DAVID-01', NOW(), NOW(), 5, 5, 0.80, NULL, @co_amiens_centre_id),
(@client_id_4, 'RECETTE-V2-DAVID-02', NOW(), NOW(), 4, 4, 0.75, NULL, @co_amiens_centre_id);
