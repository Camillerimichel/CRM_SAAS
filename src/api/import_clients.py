...
Le fournisseur n'est plus sélectionné manuellement — il est déduit automatiquement
du Ref CGP présent dans chaque ligne du fichier.
"""
...
async def clients_preview(
    ...
    return preview_clients(db, raw_rows)
...
async def clients_commit(
    ...
    return commit_clients(db, raw_rows)
