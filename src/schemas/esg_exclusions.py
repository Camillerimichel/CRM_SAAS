...
CRITERES_EXCLUSION: dict[str, dict] = {
    ...
    "lt_charbon":            {"libelle": "Charbon",                       "colonne": "excluded_coal"},
    "lt_petrole_gaz":        {"libelle": "Pétrole et gaz",                "colonne": "excluded_oil_gas"},
    "lt_sables_bitumineux":  {"libelle": "Sables bitumineux",             "colonne": "excluded_tar_sands"},
    "lt_tabac":              {"libelle": "Tabac",                        "colonne": "excluded_tobacco"},
    "lt_armement":           {"libelle": "Armement",                     "colonne": "excluded_weapons"},
    "lt_armes_controversees": {"libelle": "Armes controversées",          "colonne": "excluded_weapons_controversial"},
    "lt_jeux_argent":        {"libelle": "Jeux d'argent",                "colonne": "excluded_gambling"},
    "lt_alcool":             {"libelle": "Alcool",                       "colonne": "excluded_alcohol"},
    "lt_nucleaire":          {"libelle": "Nucléaire",                    "colonne": "excluded_nuclear"},
    "lt_pornographie":       {"libelle": "Pornographie",                 "colonne": "excluded_pornography"},
    "lt_production_fossile": {"libelle": "Production d'électricité fossile", "colonne": "excluded_fossil_power_generation"},
    "lt_corruption":         {"libelle": "Corruption",                   "colonne": "excluded_corruption"},
    "lt_droits_humains":     {"libelle": "Atteinte aux droits humains",  "colonne": "excluded_human_rights_issue"},
    "lt_travail_force":      {"libelle": "Travail forcé",                "colonne": "excluded_forced_labour"},
    "lt_environnement":      {"libelle": "Atteinte environnementale",    "colonne": "excluded_environmental_issue"},
}
